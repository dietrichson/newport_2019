...
1. Lack of to bring visual learning analytics tools into classroom settings
2. Few consider background information such as demographics or prior performance;
3. Traditional statistical visualization techniques, such as bar plots and scatter plots, are still the most commonly used in learning analytics contexts;
